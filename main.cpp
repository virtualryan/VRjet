...
void init()
{
	...
	jetB.loadModel("Model/f16E.3DS");
	mainTexs.LoadGLTextures("Textures/sky00.bmp", skyTEX );
	mainTexs.LoadGLTextures("Textures/sky00.bmp", skyTEX );
	//*************************************
	// Initialize lighting
	//*************************************
...
/* if (!lcdIsLeft())
  ...
  */
	...
	glPushMatrix();
	mainTexs.setTexture(skyTEX);
	glTranslatef(0.0,-500,-100);
